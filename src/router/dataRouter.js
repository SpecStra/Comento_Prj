...
dataRouter.get("/:id([0-9]{3}-[0-9]{2}-[0-9]{5})", getDataDetails)
dataRouter.route("/:id([0-9]{3}-[0-9]{2}-[0-9]{5})/edit").get(getDataEdit).post(uploadWare.single("attach"), postDataEdit)
dataRouter.get("/:id([0-9]{3}-[0-9]{2}-[0-9]{5})/delete", getDataDelete)
